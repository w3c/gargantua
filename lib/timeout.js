...
/**
* A delayed promise that can optionally be aborted
*
* @example
...
/**
*
* Creates an AbortSignal that aborts after a specified number of seconds
*
* @example
* const abortSignal = signal(5); // aborts after 5 seconds
