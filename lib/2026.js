...
async function fetchGroupData() {
    ...
    charter["active-charter"] = await json(group._links["active-charter"].href, { signal: abortSignal() });
    status(`Loading charter content ${group['active-charter'].uri} ...`);
    group.charterDoc = await html(charter["active-charter"].uri, { credentials: 'include', signal: abortSignal() });
